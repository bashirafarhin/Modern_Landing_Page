...
//     <section
//       ref={containerRef}
//       className="border border-pink-500 relative h-screen mx-auto"
//     >
//       <h1 className="text-center pt-30 font-bold text-[3rem]">Our Projects</h1>
//       <div
//         ref={cardsRef}
//         className="border border-blue-500 w-[80vw] mx-auto flex gap-4 px-10"
//       >
...
const OurProjects = () => {
  ...
  return (
    <div className="overflow-x-hidden">
      {" "}
      {/* ✅ Wrap everything in overflow-x-hidden */}
      <section ref={containerRef} className="relative h-screen mx-auto w-full">
        <h1 className="text-center pt-20 font-bold text-[3rem]">
          Our Projects
        </h1>
